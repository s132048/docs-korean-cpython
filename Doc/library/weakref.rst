...
.. class:: ref(object[, callback])
   ...
   Weak references are :term:`해쉬가능(hashable)` if the *object* is hashable.  They will
...
.. function:: proxy(object[, callback])
   ...
   callable.  Proxy objects are not :term:`해쉬가능(hashable)` regardless of the referent; this
